...
| **Outdoor visits** | §2 D-33, D-44, D-56; §3.8; §8 Outdoor roles; §9 Flow 2; §11.2, §12.2; §14.4, §14.9; §18; §19 R-06 | Module 12 | Coding Standards §§9, 11, 13; OpenAPI §§3–6; Design System §§4–8; Personas P-05–P-06 | Three mandatory fields only; outcome rules; supervisor boundary after handover; mobile UI; specific VPN message; online-only scope with brief-draft protection. |
...
| **OD-04** — VPN type/capacity | Required before final Outdoor Visits readiness. |
