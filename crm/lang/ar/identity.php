...
return [
    ...
    'role_administration' => [
        ...
        'system_role_cannot_be_edited' => 'هذا الدور جزء من النظام ولا يمكن تغيير اسمه. أنشئ دورًا جديدًا بدلًا من ذلك.',
        'system_role_cannot_be_deleted' => 'هذا الدور جزء من النظام ولا يمكن أرشفته.',
        'role_has_assigned_users' => 'ما زال هناك موظّفون معيَّنون على هذا الدور. انقلهم إلى دور آخر أولًا.',
        'slug_already_taken' => 'هذا المعرّف مستخدَم بالفعل في دور آخر.',
        'name_already_taken' => 'هذا الاسم مستخدَم بالفعل في دور آخر.',
        'name_ar_already_taken' => 'هذا الاسم العربي مستخدَم بالفعل في دور آخر.',
        'no_fields_submitted' => 'أدخل حقلًا واحدًا على الأقل للتغيير.',
