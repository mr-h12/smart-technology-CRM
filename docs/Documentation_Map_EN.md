...
| **Settings, managed lists & currencies** | §2 D-17, D-20, D-52, D-65; §4.8 DB-05–DB-06; §5.3; §13 screens 4–6; §15 J-03, J-12 | Module 2 | Coding Standards §§5–7, 10; OpenAPI §§6, 8 | Configuration is database-driven; FX history/audit exists; the rounding unit and its on/off switch (`D-65`) affect only new quotations. |
...
| **Customer quotations / pricing** | §2 D-03–D-11, D-26, D-36–D-37, D-42, D-46, D-50, D-52, **D-62–D-65**; §3.5 and §3.12; §4.1, §4.7–4.8; **§5 in full**; §6.1–6.6; §10.3–10.5; §14.4, §14.7; §17 | Module 7 | Coding Standards §§5–10, 13–15; OpenAPI §§4–9; Design System §§5–8; Personas P-03, P-04, P-06, P-07, P-08 | Decimal calculations; discount before tax (`D-64`); additional items outside the tax base; optional final-only rounding (`D-65`); captured FX; cost/margin visibility; Draft-only edit/delete; versioning; save blocks/warnings; `409` optimistic conflict; no supplier data in customer PDF. |
...
| **Money, FX, tax, margin, discount, or profit** | CRM §5 in full; §6 where quotation-related; Coding Standards §6 and §13; OpenAPI §8 | Decimal only, captured FX, discount before tax (`D-64`), additional items untaxed, optional final-only rounding (`D-65`), snapshots, excluded PDF fields, focused unit tests. |
